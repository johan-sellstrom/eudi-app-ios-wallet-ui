...
1. The user logs in successfully to the iProov Wallet app and views the dashboard.
2. The user clicks the 'SHOW QR' button to display the QR code.
3. The Relying Party scans the presented QR code.
4. The iProov Wallet user can view the requested data set from the relying party.
    ...
    3. The iProov Wallet user may select additional optional attributes to be shared.
5. The iProov Wallet user selects the option to share the attributes.
6. iProov Wallet authenticates to share data (quick PIN).
7. User authorization is accepted - a corresponding message is displayed to the iProov Wallet user.
